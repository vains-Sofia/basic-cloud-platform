...
import com.basic.cloud.system.api.domain.model.DynamicRouterMeta;
import com.basic.cloud.system.api.domain.model.DynamicRouterTransition;
...
public class RouterConverter {
    ...
    public List<DynamicRouter> convertToRouterTree(List<SysPermission> permissions) {
        ...
        List<SysPermission> menuList = permissions.stream()
                ...
                .sorted(Comparator.comparingInt(SysPermission::getRank))
                .toList();
