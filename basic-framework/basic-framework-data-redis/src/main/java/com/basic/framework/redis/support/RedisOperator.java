package com.basic.framework.redis.support;
...
public class RedisOperator<V> {
    ...
    public void setHashAll(String key, Object value) {
        Map<String, Object> map = JsonUtils.objectToObject(value, Map.class, String.class, Object.class);
    ...
    public <T> T getHashAll(String key, Class<T> clazz) {
        ...
        return JsonUtils.objectToObject(entries, clazz);
    }
