package com.basic.cloud.system.api.domain.model;
 ...
 */
@Data
@Schema(title = "动态路由元数据", description = "动态路由元数据模型")
public class DynamicRouterMeta implements Serializable {

    @Schema(title = "菜单名称", description = "用国际化的写法就必须在根目录的locales文件夹下对应添加")
    ...
    @Schema(title = "内嵌的iframe链接地址", description = "当路由是内嵌iframe时使用此字段指定链接地址")
    private String frameSrc;

    @Schema(title = "iframe加载状态", description = "内嵌iframe时的加载状态显示方式")
