package com.basic.cloud.redis.aop;

import com.basic.cloud.redis.exception.RedisLockException;
import com.basic.cloud.redis.annotation.RedisLock;
import com.basic.cloud.redis.enums.RedissonLockType;
...
public class RedisLockAspect {
    ...
    @Pointcut("@annotation(com.basic.cloud.redis.annotation.RedisLock)")
