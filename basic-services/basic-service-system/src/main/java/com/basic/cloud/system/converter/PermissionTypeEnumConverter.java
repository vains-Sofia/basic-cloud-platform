...
public class PermissionTypeEnumConverter extends BasicEnumConverter<Integer, PermissionTypeEnum> {

    /**
     * 调用父类构造器传入当前转换器枚举的class
     */
    public PermissionTypeEnumConverter() {
        super(PermissionTypeEnum.class);
    }
